...
echo "Adding Day 5-6 RPC methods to rpc_server.rs..."

# First, backup the file
cp node/src/rpc_server.rs node/src/rpc_server.rs.backup_day56_auto

# Add the RPC method implementations before main function
# We'll create a patch file with the complete methods

cat > day56_methods.patch << 'METHODS'
...
echo "✅ RPC methods prepared in day56_methods.patch"
echo ""
echo "⚠️  IMPORTANT: You need to:"
echo "1. Add the methods from day56_methods.patch to node/src/rpc_server.rs (before main())"
echo "2. In main(), find the RPC server builder and add:"
