...
pub struct EthereumGrpcService {}

#[tonic::async_trait]
impl ChainService for EthereumGrpcService {
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let service = EthereumGrpcService::default();

    println!("⚡ Ethereum gRPC server listening on {}", addr);
