...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║      BUILDING CLEAN COSMOS SDK BLOCKCHAIN (NO LIBP2P)        ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""

# Create clean directory
SULTAN_DIR="/workspaces/0xv7/sultan-clean"
rm -rf $SULTAN_DIR
mkdir -p $SULTAN_DIR
cd $SULTAN_DIR

echo "🔧 Step 1: Creating clean go.mod without libp2p"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo ""
echo "🔧 Step 2: Creating minimal working app"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
func NewApp(
    ...
    // Register routes
    app.ModuleManager.RegisterRoutes(bApp.Router(), bApp.QueryRouter(), legacyAmino)
...
go mod tidy 2>&1 | grep -v "downloading" | head -5
...
if [ -f "sultand" ]; then
    ...
    echo "⚠️ Build needs additional fixes..."
fi
