module github.com/wollnbergen/sultan-cosmos-module
...
require (
	...
	github.com/wollnbergen/sultan-cosmos-bridge v0.1.0
...
replace github.com/wollnbergen/sultan-cosmos-bridge => ../sultan-cosmos-bridge/go
